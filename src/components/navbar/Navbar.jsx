    ...
    return (
        <>
            ...
            <Navbar
                ...
                style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : '#325E7A' }}>
                ...
                <div className="flex items-center justify-between text-blue-gray-900">
                    ...
                    <Link to={'/'}>
                        ...
                        >
                            ...
                            <img
                                className=' w-16 h-16 '
                                src='https://cdn-icons-png.flaticon.com/128/3621/3621446.png'
                            />
                            {/* Logo Text  */}
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="">
                                <Avatar
                                    key={1}
                                    src={'https://png.pngtree.com/png-vector/20190703/ourmid/pngtree-security-user-avatar-collection-free-vector-png-image_1535590.jpg'}
                                    alt="avatar"
                                    withBorder={true}
