        ...
        <Layout>
            <div className="py-10">
                <div
                    ...
                    <div className="left">
                        <img
                            className=" w-40 h-40  object-cover rounded-full border-2 border-[#5DCD11] p-1"
                            src={'https://png.pngtree.com/png-vector/20190703/ourmid/pngtree-security-user-avatar-collection-free-vector-png-image_1535590.jpg'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">adarshshrivastava.dev@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
                ...
                <div className="">
                    <div className=' container mx-auto px-4 max-w-7xl my-5' >
                        <div className="relative overflow-x-auto shadow-md sm:rounded-xl">
                            {/* table  */}
                            <table className="w-full border-2 border-[#5DCD11] shadow-md text-sm text-left text-gray-500 dark:text-gray-400" >
                                {/* thead  */}
                                <thead
                                    style={{
                                        background: mode === 'dark'
